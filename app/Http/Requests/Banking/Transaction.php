...
class Transaction extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'contact_id' => 'nullable|integer|exists:contacts,id,company_id,' . $company_id . ',deleted_at,NULL',
            'category_id' => 'required|integer|exists:categories,id,company_id,' . $company_id . ',deleted_at,NULL',
