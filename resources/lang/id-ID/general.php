...
return [
    ...
    'recurring_incomes'     => 'Pendapatan Rutin|Pendapatan Rutin',
    'expenses'              => 'Biaya|Biaya',
    'recurring_expenses'    => 'Pengeluaran Rutin|Pengeluaran Rutin',
    'direct_costs'          => 'Biaya Langsung|Biaya Langsung',
    'cogs'                  => 'Harga Pokok Penjualan|Harga Pokok Penjualan',
    'bills'                 => 'Tagihan|Tagihan',
    'recurring_bills'       => 'Tagihan Rutin|Tagihan Rutin',
    'vendors'               => 'Pemasok|Pemasok',
    'accounts'              => 'Akun|Akun',
    'transfers'             => 'Transfer|Transfer',
    'income_transfers'      => 'Transfer Pendapatan|Transfer Pendapatan',
    ...
    'get_paid_faster'       => 'Dapatkan pembayaran 3x lebih cepat:',
    ...
    'form' => [
        ...
        'choose'            => 'Pilih :field',
        'choose_different'  => 'Pilih :field lain',
    ...
    'placeholder' => [
        ...
        'search_and_filter' => 'Cari atau saring hasil...',
        'select_and_filter' => 'Pilih salah satu dari opsi yang tersedia di bawah',
        'enter_and_filter'  => 'Tekan enter untuk menyaring hasil, atau atur penyaring baru',
        'contact_search'    => 'Ketik nama :type',
    ...
    'empty' => [
        'documentation' => 'Lihat <a href=":url" target="_blank" class="text-green bg-no-repeat bg-0-2 bg-0-full hover:bg-full-2 bg-gradient-to-b from-transparent to-green transition-backgroundSize">dokumentasi</a> untuk detail lebih lanjut.',
        ...
        'bills' => 'Tagihan bisa sekali atau berulang. Mereka menunjukkan apa yang Anda berutang kepada pemasok Anda untuk produk atau layanan yang Anda beli.',
        ...
        'vendors' => 'Pemasok diperlukan jika Anda ingin membuat tagihan. Anda dapat melihat saldo yang Anda berutang dan menyaring laporan berdasarkan pemasok.',
        ...
        'transactions' => 'Transaksi memungkinkan Anda membuat catatan atas pendapatan atau pengeluaran Anda. Pembayaran dari faktur/tagihan juga tercantum di sini.',
        'taxes' => 'Pajak digunakan untuk menerapkan biaya tambahan untuk faktur dan tagihan. Keuangan Anda dipengaruhi oleh pajak regulasi ini.',
        ...
        'recurring_templates' => 'Templat Berulang adalah pemasukan atau pengeluaran.',

        'actions' => [
            'new' =>    'Masukkan detailnya dan buat :type pertama Anda',
            'import' => 'Impor :type yang telah ada dengan satu klik',
        ],
    ],
