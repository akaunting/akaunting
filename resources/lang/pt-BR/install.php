...
return [
    ...
    'steps' => [
        ...
        'language'          => 'Passó 1/3 : Selecionar idioma',
        'database'          => 'Passó 2/3 : Configuração do Banco de Dados',
        'settings'          => 'Passó 3/3 : Detalhes da empresa e do administrador',
    ],
    ...
    'requirements' => [
        ...
        'npm'               => '<b>Arquivos JavaScript ausentes!</b> <br><br><span>É precisó executar os comandos <em class="underline">npm install</em> e <em class="underline">npm run dev</em> .</span>', 
    ],
    ...
    'settings' => [
        ...
        'company_e-mail'     => 'E-mail da empresa',
        'admin_e-mail'       => 'E-mail do Admin',
