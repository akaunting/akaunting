...
return [
    ...
    'account' => 'Conta',
    'category' => 'Categoria',
    'connect' => 'Esta transação está conectada a :count documento(s)',
    'connect_message' => 'Impostos para este(a) :type não foram calculados',
    'connected' => 'Conectado',
    'create_document_transaction_error' => 'Este endpoint não pode ser adicionado a um documento',
    'delete_document_transaction_error' => 'Este endpoint não pode ser excluído de um documento',
];
