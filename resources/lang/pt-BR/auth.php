...
return [
    ...
    'enter_e-mail'           => 'Entre com o seu endereço de e-mail',
    'current_e-mail'         => 'E-mail atual',
    'reset'                 => 'Resetar',
    'never'                 => 'Nunca',
    ...
    'form_description' => [
        ...
        'assign'            => 'O usuário terá acessó às empresas selecionadas. É possível restringir as permissões na página <a href=":url" class="border-b border-black">funções</a>.',
    ...
    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Eles têm acessó total ao seu Akauning, incluindo clientes, faturas, relatórios, configurações e apps.',
        ],
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Eles têm acessó total ao seu Akaunting, mas não podem gerenciar usuários e apps.',
        ],
        'customer' => [
            'name'          => 'Cliente',
