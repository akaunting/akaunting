...
return [
    ...
    'invoices'              => 'Faturas',
    'payments'              => 'Pagamentos',
    'payment_received'      => 'Pagamento recebido, obrigatório.',
    ...
    'latest_invoices'       => [
        ...
        'description'       => ':daté - Foi faturado com o número da fatura :invoice_number.',
    ...
    'payment_history'       => [
        ...
        'description'       => ':daté - Efetuado um pagamento de :amount.
',
        'invoice_description'=> ':daté - Efetuado um pagamento de :amount para a fatura número :invoice_number.',

        'no_data'           => 'Não tem histórico de pagamentos, ainda.',
    ],

    'payment_detail'        => [
        'description'       => 'Efetuado um pagamento :amount em :daté para essa fatura.'
    ],
