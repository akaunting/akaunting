...
return [
    ...
    'payments_received'     => 'Приети плащания',
    'over_payment'          => 'Сумата, която сте въвели, преминава общата: :amount',
    ...
    'messages' => [
        ...
        'totals_required'   => 'Необходими са общи суми по фактурите. Моля, редактирайте :type и го запазете отново.',
        ...
        'name_or_description_required' => 'Вашата фактура трябва да показва поне едно от <b>:name</b> или <b>:description</b>.',
    ],
