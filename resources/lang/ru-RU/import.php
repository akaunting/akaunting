...
return [
    ...
    'bank_feeds'    => 'Импортируйте транзакции безопасно, подключив банковские счета для автоматизации бухгалтерского учёта',
    'receipts'      => 'Экономьте время, загружая чеки, фиксируя расходы и исключая ручную работу!',
    'ofx'           => 'Без усилий импортируйте банковские транзакции с приложением OFX и автоматизируйте управление финансами!',
    'mt940'         => 'Легко загружайте банковские выписки в формате MT940 и управляйте своими финансами без труда!',
