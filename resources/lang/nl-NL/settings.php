...
return [
    ...
    'localisation' => [
        ...
        'discount_location' => [
            'name'                      => 'Kortingslocatie',
            'item'                      => 'Op regel',
            'total'                     => 'In totaal',
            'both'                      => 'Zowel regel als totaal',
        ],
        ...
        'form_description' => [
            ...
            'other'                     => 'Selecteer de plaats waar het percentageteken wordt weergegeven voor belastingen. U kunt kortingen inschakelen op regelitems en op het totaal voor facturen en inkoopfacturen.',
        ],
    ],
    ...
    'invoice' => [
        ...
        'title'                         => 'Titel',
        'subheading'                    => 'Subkop',
        'due_receipt'                   => 'Verschuldigd bij ontvangst',
        'due_days'                      => 'Verschuldigd binnen :days dagen',
        'due_custom'                    => 'Aangepast aantal dagen',
        'due_custom_day'                => 'na dag',
        'choose_template'               => 'Factuursjabloon kiezen',
        'default'                       => 'Standaard',
        'classic'                       => 'Klassiek',
        'modern'                        => 'Modern',
        'logo_size_width'               => 'Logobreedte',
        'logo_size_height'              => 'Logo hoogte',
        'hide' => [
            'item_name'                 => 'Artikelnaam verbergen',
            'item_description'          => 'Artikelomschrijving verbergen',
            'quantity'                  => 'Aantal verbergen',
    ...
    'email' => [
        'description'                   => 'Wijzig het verzendprotocol',
        ...
        'templates' => [
            ...
            'bill_remind_admin'         => 'Inkoopfactuurherinneringssjabloon (verzonden naar de beheerder)',
            'bill_recur_admin'          => 'Terugkerende inkoopfactuursjabloon (verzonden naar de beheerder)',
    ...
    'scheduling' => [
        'name'                          => 'Planning',
        'description'                   => 'Automatische herinneringen en terugkerende facturen',
        'search_keywords'               => 'automatisch, herinnering, terugkerend, cron, commando',
        'send_invoice'                  => 'Factuurherinnering sturen',
        'invoice_days'                  => 'Aantal dagen na vervaldatum sturen',
        'send_bill'                     => 'Inkoopfactuurherinnering sturen',
        'bill_days'                     => 'Aantal dagen voor vervaldatum sturen',
        'cron_command'                  => 'Cron-opdracht',
        'command'                       => 'Opdracht',
        'schedule_time'                 => 'Uur om uit te voeren',

        'form_description' => [
            'invoice'                   => 'Schakel in of uit en stel herinneringen in voor uw facturen wanneer ze achterstallig zijn.',
            'bill'                      => 'Schakel in of uit en stel herinneringen in voor uw inkoopfacturen voordat ze achterstallig zijn.',
            'cron'                      => 'Kopieer de cron-opdracht die uw server moet uitvoeren. Stel het uur in om de gebeurtenis te activeren.',
        ]
    ],
