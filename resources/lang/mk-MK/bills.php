...
return [
    ...
    'form_description' => [
        'billing'           => 'Деталите за наплата се појавуваат во вашата сметка. Датумот на сметката се користи во контролната табла и извештаите. Изберете го датумот на кој очекувате да платите како датум на доспевање.',
    ],

    'messages' => [
        'draft'             => 'Ова е <b>НАЦРТ</b> сметка и ќе се прикаже на графиконите откако ќе биде примена.',
