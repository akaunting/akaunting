...
return [
    ...
    'recurring_expenses'    => 'Повторувачки трошок|Повторувачки трошоци',
    'direct_costs'          => 'Директен трошок|Директни трошоци',
    'cogs'                  => 'Трошок на продажба|Трошок на продажба',
    'bills'                 => 'Сметка|Сметки',
    ...
    'currency_rates'        => 'Курс на валута|Курсеви на валути',
    ...
    'reconciliations'       => 'Усогласување|Усогласувања',
    ...
    'cities'                => 'Град / населено место|Градови / населени места',
    ...
    'contact_persons'       => 'Контакт лице|Контакт лица',
    'bank_feeds'            => 'Банкарски довод|Банкарски доводи',
    'discounts'             => 'Попуст|Попусти',
    'tokens'                => 'Токен|Токени',
    'clients'               => 'Клиент|Клиенти',
    'ofx'                   => 'OFX',
    'mt940'                 => 'MT940',
    ...
    'color'                 => 'Боја',
    'save'                  => 'Зачувај',
    'save_and_send'         => 'Зачувај и испрати',
    'confirm'               => 'Потврди',
    'cancel'                => 'Откажи',
    'loading'               => 'Се вчитува...',
    'from'                  => 'Од',
    ...
    'last_received'         => 'Последно примено :date',
    ...
    'validation_warning'    => 'Предупредување за валидација',
    'dismiss'               => 'Отфрли',
    'size'                  => 'Големина',
    'media'                 => 'Медиуми',
    'pdf_file'              => ':type како PDF датотека',
    'before_tax'            => 'Пред данок',
    'action_required'       => 'Потребна е акција',
    'get_paid_faster'       => 'Наплатете 3x побрзо:',
    'currency_convert'      => ':from во :to',
    ...
    'date_range' => [
        ...
        'last_days'     => 'Последни :number дена',
        'last_months'   => 'Последни :number месеци',
        'last_quarters' => 'Последни :number квартали',
        'last_years'    => 'Последни :number години',
        'this_week'     => 'Оваа недела',
        'this_month'    => 'Овој месец',
        'this_quarter'  => 'Овој квартал',
        'this_year'     => 'Оваа година',
        'year_to_date'  => 'Од почетокот на годината',
        'previous_week' => 'Претходна недела',
        'last_month'    => 'Минатиот месец',
        'previous_month'=> 'Претходен месец',
    ...
    'pin_text' => [
        'pin_tab'           => 'Закачи стандардно јазиче',
        'unpin_tab'         => 'Откачи стандардно јазиче',
    ],
    ...
    'empty' => [
        ...
        'reconciliations' => 'Усогласувањето е процес со кој се обезбедува изедначување на евиденцијата со банкарските сметки на вашата компанија.',
