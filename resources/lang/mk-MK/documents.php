...
return [
    ...
    'tax_rate' => [
        'changed_title'         => 'Даночните стапки се променети откако е креиран овој запис',
        'changed_description'   => 'Износите подолу ги користат стапките што биле наплатени во моментот на креирање. Ако зачувате без пресметка, тие остануваат непроменети.',
        'recalculate'           => 'Пресметај ги даноците повторно со тековните стапки',
        'charged_at'            => 'Овој износ ја користи стапката наплатена при креирање на записот (:rate). Овозможете ја опцијата за повторна пресметка погоре за да се ажурира.',
    ],
