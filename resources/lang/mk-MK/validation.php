...
return [
    ...
    */
    ...
    'double' => 'Полето :attribute мора да биде валиден децимален број.',
    ...
    'in_detailed' => 'Вредноста на :attribute ":value" е невалидна. Очекувана е една од: :values',
    ...
    'starts_with' => ':attribute мора да започнува со едно од следниве: :values.',
    ...
    */
    ...
    'custom' => [
        ...
        'invalid_quantity'      => ':attribute не е валиден математички израз.',
        ...
        'invalid_colour'        => 'Бојата на :attribute е невалидна.',
        'invalid_payment_method'=> 'Методот на плаќање е невалиден.',
    ],
