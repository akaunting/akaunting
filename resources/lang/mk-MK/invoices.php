...
return [
    ...
    'payments_received'     => 'Примени плаќања',
    'over_payment'          => 'Износот што го внесовте го надминува вкупниот износ: :amount',
    ...
    'messages' => [
        ...
        'draft'             => 'Ова е <b>НАЦРТ</b> фактура и ќе се прикаже на графиконите откако ќе биде испратена.',
        'totals_required'   => 'Вкупните износи на фактурата се задолжителни. Изменете го :type и зачувајте повторно.',
        ...
        'name_or_description_required' => 'Вашата фактура мора да прикажува барем едно од <b>:name</b> или <b>:description</b>.',
    ],
