...
return [
    ...
    'email' => [
        ...
        'templates' => [
            ...
            'bill_recur_admin'          => 'Шаблон за Повторувачка Сметка (пратен на администратор)',
    ...
    'scheduling' => [
        ...
        'send_invoice'                  => 'Испрати потсетник за фактури',
        'invoice_days'                  => 'Испрати по денови од доспевање',
    ...
    'currencies' => [
        'description'                   => 'Креирајте и управувајте со валути и одредете ги нивните курсеви',
