...
return [
    ...
    'accept_payments'       => 'Menerima bayaran online',
    'payments_received'     => 'Bayaran diterima',
    'over_payment'          => 'Jumlah yang Anda masukkan melebihi total: :amount',

    'form_description' => [
        'billing'           => 'Detail penagihan muncul di faktur Anda. Tanggal Invois digunakan di dasbor dan laporan. Pilih tanggal yang Anda harapkan untuk dibayar sebagai Tanggal Jatuh Tempo.',
    ],
    ...
    'messages' => [
        ...
        'draft'             => 'Invois ini merupakan <b>DRAFT</b> dan akan terlihat pada grafik ketika sudah dibayarkan',
        ...
        'name_or_description_required' => 'Invois Anda harus menunjukkan setidaknya <b>:name</b> atau <b>:decription</b>',
    ],
