...
return [
    ...
    'invoice_recur_admin' => [
        'subject'       => '{invoice_number} facture récurrente créée',
        'body'          => 'Bonjour,<br /><br />Selon le cycle de facturation de {customer_name}, la facture <strong>{invoice_number}</strong> a été automatiquement créée.<br /><br />Vous pouvez voir les détails de la facture à partir du lien suivant : <a href="{invoice_admin_link}">{invoice_number}</a>.<br /><br />Cordialement,<br />{company_name}',
    ],
    ...
    'bill_remind_admin' => [
        'subject'       => '{bill_number} avis de rappel de facture d\'achat',
        'body'          => 'Bonjour,<br /><br />Ceci est un rappel de paiement pour la facture d\'achat <strong>{bill_number}</strong> de {vendor_name}.<br /><br />Le montant de cette facture est de {bill_total} et est dû le <strong>{bill_due_date}</strong>.<br /><br />Vous pouvez voir les détails de la facture à partir du lien suivant : <a href="{bill_admin_link}">{bill_number}</a>.<br /><br />Cordialement,<br />{company_name}',
    ],

    'bill_recur_admin' => [
        'subject'       => '{bill_number} facture d\'achat récurrente créée',
        'body'          => 'Bonjour,<br /><br />Sur la base du cycle de facturation de {vendor_name}, la facture d\'achat <strong>{bill_number}</strong> a été automatiquement créée.<br /><br />Vous pouvez voir les détails de la facture à partir du lien suivant : <a href="{bill_admin_link}">{bill_number}</a>.<br /><br />Cordialement,<br />{company_name}',
    ],
