...
return [
    ...
    'direct_costs'          => 'Coût direct|Coûts directs',
    'cogs'                  => 'Coût des ventes|Coûts des ventes',
    ...
    'currency_rates'        => 'Taux de change|Taux de change',
    ...
    'bank_feeds'            => 'Flux bancaire|Flux bancaires',
    'receipts'              => 'Reçu|Reçus',
    'discounts'             => 'Remise|Remises',
    'tokens'                => 'Jeton|Jetons',
    ...
    'validation_warning'    => 'Avertissement de validation',
    'dismiss'               => 'Masquer',
    'size'                  => 'Taille',
    'media'                 => 'Média',
    ...
    'date_range' => [
        ...
        'last_days'         => 'Les :number derniers jours',
    ...
    'pin_text' => [
        'pin_tab' => 'Épingler l\'onglet par défaut',
        'unpin_tab' => 'Désépingler l\'onglet par défaut',
    ],

    'empty' => [
        'documentation' => 'Consultez la <a href=":url" target="_blank" class="text-green bg-no-repeat bg-0-2 bg-0-full hover:bg-full-2 bg-gradient-to-b from-transparent to-green transition-backgroundSize">documentation</a> pour plus de détails.',
