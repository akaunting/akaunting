<head>
    ...
    @endif
    <!-- Data Tables -->
    <link rel="stylesheet" href="{{ asset(AKAUNTING_PUBLIC . 'adminlte/plugins/datatables/dataTables.bootstrap.css') }}">
    <!-- Select2 -->
    ...
    <!-- Data Tables -->
    <script src="{{ asset(AKAUNTING_PUBLIC . 'adminlte/plugins/datatables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset(AKAUNTING_PUBLIC . 'adminlte/plugins/datatables/dataTables.bootstrap.min.js') }}"></script>
    <!-- AdminLTE App -->
