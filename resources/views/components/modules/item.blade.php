    ...
    <div class="flex flex-col py-2 justify-between align-bottom">
        <div class="flex items-baseline justify-between">
            ...
            @if (! empty($module->subscription_type))
                <span class="ltr:mr--3 rtl:ml--3 ltr:float-right rtl:float-left">
            ...
            @if (isset($installedStatus[$module->slug]))
                ...
                <span class="{{ !empty($module->subscription_type) ? 'ltr:mr-2 rtl:ml-2' : 'ltr:mr--3 rtl:ml--3' }} ltr:float-right rtl:float-left">
