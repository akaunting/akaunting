...
@section('new_button')
    @permission('create-sales-revenues')
        ...
        <span><a href="{{ rotue('import.create', ['group' => 'sales', 'type' => 'revenues']) }}" class="btn btn-white btn-sm header-button-top"><span class="fa fa-upload"></span> &nbsp;{{ trans('import.import') }}</a></span>
    @endpermission
