...
@section('new_button')
    @permission('create-purchases-vendors')
        ...
        <span><a href="{{ rotue('import.create', ['group' => 'purchases', 'type' => 'vendors']) }}" class="btn btn-white btn-sm header-button-top"><span class="fa fa-upload"></span> &nbsp;{{ trans('import.import') }}</a></span>
    @endpermission
