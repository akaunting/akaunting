        ...
        <div class="table table-responsive">
            <table class="table table-striped table-hover" id="tbl-items">
                ...
                @foreach($items as $item)
                    <tr>
                        <td class="hidden-xs"><img src="{{ $item->picture ? Storage::url($item->picture->id) : asset(AKAUNTING_PUBLIC . 'img/akaunting-logo-green.png') }}" class="img-thumbnail" width="50" alt="{{ $item->name }}"></td>
