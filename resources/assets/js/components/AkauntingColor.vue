    ...
    <base-input :label="title" :name="name"
        ...
        <transition name="fade">
            <div v-show="isOpen"
                ...
                class="border border-gray-300 ltr:origin-top-right rtl:origin-top-left absolute ltr:left-0 rtl:right-0 top-full mt-2 rounded-md shadow-lg z-10 el-popper"
                :class="[popperClass]"
