            ...
            <form>
                <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5 mt-0">
                    <div class="sm:col-span-6 required" :class="[{'has-error': form.errors.get('hostname')}]">
                        <label for="hostname" class="text-black text-sm font-medium">
                            Hostname
                        </label>
                    ...
                    <div class="sm:col-span-6 required">
                        <label for="username" class="text-black text-sm font-medium">
                            Username
                        </label>
                    ...
                    <div class="sm:col-span-6">
                        <label for="password" class="text-black text-sm font-medium">
                            Password
                        </label>
                        ...
                        <div class="input-group input-group-merge">
                            <div class="relative">
                                <input 
                                    :class="[
                                        {
                                            'border-red': form.errors.get('password')
                                        },
                                        {
                                            'border-light-gray': !form.errors.get('password')
                                        },
                                        {
                                            'ltr:pr-9': form.password,
                                            'rtl:pl-9': form.password
                                        },
                                        {
                                            'ltr:pr-0': ! form.password,
                                            'rtl:pl-0': ! form.password
                                        },
                                    ]"
                    ...
                    <div class="sm:col-span-6 required">
                        <label for="database" class="text-black text-sm font-medium">
                            Database
                        </label>
