    ...
    */
    'fallback' => [
        ...
        'invoice' => [
            ...
            'unit_name'                 => env('SETTING_FALLBACK_INVOICE_UNIT_NAME', 'settings.invoice.unit'),
            ...
            'hide_unit'                 => env('SETTING_FALLBACK_INVOICE_HIDE_UNIT', false),
        ...
        'bill' => [
            ...
            'unit_name'                 => env('SETTING_FALLBACK_BILL_UNIT_NAME', 'settings.invoice.unit'),
