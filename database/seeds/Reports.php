    ...
    private function create()
    {
        ...
        $rows = [
            [
                ...
                'class' => \App\Reports\IncomeSummary::class,
            ...
            [
                'company_id' => $company_id,
                'class' => \App\Reports\ExpenseSummary::class,
            ...
            [
                'company_id' => $company_id,
                'class' => \App\Reports\IncomeExpenseSummary::class,
            ...
            [
                'company_id' => $company_id,
                'class' => \App\Reports\ProfitLoss::class,
                'name' => trans('reports.profit_loss'),
                'description' => trans('demo.reports.profit_loss'),
                'settings' => ['group' => 'category', 'period' => 'quarterly', 'basis' => 'accrual', 'show_percentage' => 'no'],
            ],
            [
                'company_id' => $company_id,
                'class' => \App\Reports\TaxSummary::class,
